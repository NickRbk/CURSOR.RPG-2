...
class Labyrinth {
    ...
    private void labyrinthGenerator() throws IOException {
        ...
        Room r1 = new Room(list.get(0), list.get(1), 0);
        Room r2 = new Room(list.get(0), list.get(1), 0);
    ...
    private void createMainLine(List<String> list, Room r1, Room r2) {
        ...
        for (int i = 1; i < maxLength; i++) {
            ...
            r2 = new Room(list.get(number1),list.get(number1+1), i);
            setExits(r1, r2);
            labyrinth.add(r2);
            r1 = r2;
        }
        r2 = new Room(list.get(2),list.get(3), labyrinth.size());
        setExits(r1, r2);
    ...
    private void createSideline(List<String> list, Room r1, Room r2) {
        ...
        for (int i = 0; i < Math.random() * 3; i++) {
            int number1 = (int) (Math.random() * 12 + 0.01) * 2 + 4;
            r2 = new Room(list.get(number1),list.get(number1+1), labyrinth.size());
            setExits(r1, r2);
            labyrinth.add(r2);
            r1 = r2;
        }
